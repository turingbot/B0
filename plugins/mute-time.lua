...
local function run(msg, matches)
  if matches[1]:lower() == 'mt' and is_admin(msg) or matches[1]:lower() == 'تعطیل' and is_admin(msg) then
     local hash = 'mute_time:'..msg.chat_id_
  ...
  if matches[1]:lower() == 'unmt' and is_admin(msg) or matches[1]:lower() == 'لغو تعطیل' and is_admin(msg) then
     local hash = 'mute_time:'..msg.chat_id_
     redis:del(hash)
